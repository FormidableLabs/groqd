    ...
    <Menu as="div" className="relative inline-block">
      {({ open }) => (
        <React.Fragment>
          ...
          >
            <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none flex flex-col gap-2 p-2 z-[2]">
              {items.map((item) => (
